...
public class Nutrition extends Activity{
	...
	double macro_result;
	String savedplan;
	String goal_spinner_text;
	String nutrtion_spinner_text;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		auto_goal=sharedpreferences.getInt("goal_health_position", 0);
		Astatus = sharedpreferences.getString("bmr_key", "0");
		auto_diet=sharedpreferences.getInt("diet_key", 0);
		...
		goal_spinner.setSelection(auto_goal);
		goal_spinner_text=goal_spinner.getSelectedItem().toString();
		Log.e("", "first spinner "+goal_spinner_text);


		if(goal_spinner_text.equals("Gain Weight"))
		{
		...
		if(goal_spinner_text.equals("Loss Weight"))
		{
			tdde_activity=text_gaol.getText().toString();
			tdde_num=Double.parseDouble(tdde_activity);
			tdde_goal=tdde_num-(tdde_num*0.20);
		...
		if(goal_spinner_text.equals("Maintain Weight"))
		{
			tdde_activity=text_gaol.getText().toString();
			tdde_num=Double.parseDouble(tdde_activity);
			tdde_goal=tdde_num;
		...
		ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, setnutri);
		dataAdapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		// attaching data adapter to spinner
		nutri_spinner.setAdapter(dataAdapter1);

		nutri_spinner.setSelection(auto_diet);
		nutrtion_spinner_text=nutri_spinner.getSelectedItem().toString();
		Log.e("", "2nd spinner "+nutrtion_spinner_text);
		macro_result=Double.parseDouble(Astatus);

		if(nutrtion_spinner_text.equals("Ketogenic Macro"))
		{
		...
		if(nutrtion_spinner_text.equals("Zone Macro"))
		{
		...
		if(nutrtion_spinner_text.equals("Low Carb Macro"))
		{
